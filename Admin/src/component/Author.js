...
const Side = props => {
  ...
  const submit = () => {
    ...
    axios.post(process.env.REACT_APP_BACKEND+"author/create", formData);
    ...
    <div style={{ padding: '5%' }}>
      <table class="table table-condensed">
        ...
        <tbody>
          <tr>
            <th>
              <input type="text" className="form-control" name="user" placeholder="نویسنده" onChange={evt => { name = evt.target.value; }} required />
            </th>
            <th>
