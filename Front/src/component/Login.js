                                ...
                                <div className="col-md-6 col-lg-4">
                                    <div className="login-wrap p-0">
                                        ...
                                        <form action="#" className="signin-form">
                                            ...
                                            <div className="form-group">
                                                <button type="submit" className="form-control btn btn-primary submit px-3">ورود</button>
                                            </div>
                                        </form>
                                        <p className="w-100 text-center">&mdash; یا &mdash;</p>
                                        <div className="social d-flex text-center">
                                            <Link to='/signup' className="px-2 py-2 mr-md-1 rounded" style={{ width: '100%' }} ><button style={{ width: '100%' }} className="form-control btn btn-primary submit px-3">ثبت نام</button></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
